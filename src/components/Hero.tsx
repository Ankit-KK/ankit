  ...
  return (
    ...
    >
      <div className="section-container flex flex-col items-center justify-center text-center">
        <div className="mb-8 inline-flex items-center justify-center rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary animate-fade-in" 
        ...
        >
          ...
          <a
            ...
            className={cn(
              ...
              "hover:bg-secondary/70 transition-all"
            )}
          >
